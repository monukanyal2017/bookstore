...
export class PayService {
    ...
    paynow(productlist,price,mobilenum){
        ...
        return this.http.post<any>('/api/mpesa/c2b_pay',{price:price,mobilenum:mobilenum}, { observe: 'response', responseType: 'json', headers: header }).pipe(map((res) => { console.log(res.body); return res.body; }));
