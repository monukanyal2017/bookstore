...
export class PayService {
    ...
    paynow(productlist,price,mobilenum){
        ...
        return this.http.post<any>('/api/mpesa/c2b_pay',{productlist:productlist,price:price.toString(),mobilenum:mobilenum}, { observe: 'response', responseType: 'json', headers: header }).pipe(map((res) => { console.log(res.body); return res.body; }));
